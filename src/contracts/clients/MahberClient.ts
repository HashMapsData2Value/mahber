...
export type Mahber = {
  ...
  methods:
    ...
    & Record<'publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void' | 'publicChallengeLsig', {
      argsObj: {
        /**
         * The message to be signed
         */
...
export abstract class MahberCallFactory {
  ...
  /**
   * Constructs a no op call for the publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void ABI method
   *
   * publicChallengePublic wrapper around the challenge method, allowing it to be tested directly.
   *
   * @param args Any args for the contract call
   ...
   * @returns A TypedCallParams object for the call
   */
  static publicChallengeLsig(args: MethodArgs<'publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void' as const,
...
export class MahberClient {
  ...
  /**
   * Calls the publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void ABI method.
   *
   * publicChallengePublic wrapper around the challenge method, allowing it to be tested directly.
   *
   * @param args The arguments for the contract call
   ...
   * @returns The result of the call: - the content of the privateChallenge call
   */
  public publicChallengeLsig(args: MethodArgs<'publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
  ...
  public compose(): MahberComposer {
    ...
    return {
      ...
      publicChallengeLsig(args: MethodArgs<'publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void'>, params?: AppClientCallCoreParams & CoreAppCallArgs) {
...
export type MahberComposer<TReturns extends [...any[]] = []> = {
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  publicChallengeLsig(args: MethodArgs<'publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void'>, params?: AppClientCallCoreParams & CoreAppCallArgs): MahberComposer<[...TReturns, MethodReturn<'publicChallengeLsig(byte[],byte[],byte[],byte[],byte[],pay)void'>]>
